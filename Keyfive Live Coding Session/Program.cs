...
// Create a Telemetry.cs class file that Implements 'ITelemetry'

// The Telemetry class should represent data collected from a device. Each telemetry object will have:
